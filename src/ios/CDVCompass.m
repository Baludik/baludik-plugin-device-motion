...
- (void)returnHeadingInfo:(NSString*)callbackId keepCallback:(BOOL)bRetain
{
    ...
    if (hData && (hData.headingStatus == HEADINGERROR)) {
        ...
        [returnInfo setObject:[NSNumber numberWithDouble:hInfo.x] forKey:@"x"];
        [returnInfo setObject:[NSNumber numberWithDouble:hInfo.y] forKey:@"y"];
        [returnInfo setObject:[NSNumber numberWithDouble:hInfo.z] forKey:@"z"];
